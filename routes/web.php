...
// Route Midtrans (buat transaksi Snap)
Route::post('/checkout/{id}/midtrans', [MidtransController::class, 'createTransaction'])
    ...
    Route::get('/keranjang/data', [CartController::class, 'getData'])->name('keranjang.data');
    ...
    Route::post('/pesanan/{id}/ulasan', [PesananController::class, 'ulasan'])
    ->name('pesanan.ulasan');
