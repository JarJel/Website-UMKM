<?php
$nama_sekolah = "SD Raudhatul Jannah 2";
?>
...
<body class="bg-gray-200">
        ...
        <section id="kontak" class="py-16 px-6 md:px-12 bg-white rounded-xl shadow-lg mx-4 md:mx-auto max-w-6xl mt-8 mb-8">
            ...
            <div class="flex flex-col md:flex-row justify-center items-start md:space-x-12">
                <div class="md:w-1/2 mb-8 md:mb-0">
                    <p class="text-gray-700 mb-4"><strong class="text-[#B82132] drop-shadow-lg">Alamat:</strong> Jl. Pendidikan No. 123, Kota Harapan, 12345</p>
                    <p class="text-gray-700 mb-4"><strong class="text-[#B82132] drop-shadow-lg">Telepon:</strong> (021) 123-4567</p>
                    <p class="text-gray-700 mb-4"><strong class="text-[#B82132] drop-shadow-lg">Email:</strong> info@sekolahimpian.sch.id</p>
                    <div class="mt-6">
                ...
                <div class="md:w-1/2 w-full">
                    ...
                    <form class="space-y-4" action="submit_message.php" method="POST">
                        ...
                        <input type="hidden" name="unit_asal" value="SD 2">
                        <input type="hidden" name="redirect_url" value="sd2.php"> <div>
    ...
    <script>
        ...
        const kelasOptions = {
            '1': [
                { name: 'Kelas Abu Dzar Al Ghifari', url: '' },
                { name: 'Kelas Abdurrahman bin Auf', url: '' },
            ],
            '2': [
                { name: 'Kelas Bilal bin Rabah', url: '' }
            ]
        };
