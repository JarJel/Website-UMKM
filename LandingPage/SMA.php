<?php
$nama_sekolah = "SMA Raudhatul Jannah";
?>
...
<head>
    ...
    <style>
        ...
        .primary-color {
            background-color: #27445D; /* Diperbarui agar sesuai dengan penggunaan di elemen */
        }

        /* Mengubah definisi text-primary-color agar sesuai dengan warna yang digunakan di elemen */
        .text-primary-color {
            color: #27445D; /* Diperbarui agar sesuai dengan penggunaan di elemen */
        }

        .border-primary-color {
            border-color: #27445D; /* Diperbarui agar sesuai dengan penggunaan di elemen */
        }
...
<body class="bg-gray-200">
    ...
    <div class="pt-[]">
        <section id="beranda" class="text-white py-20 px-6 text-center rounded-b-xl shadow-lg min-h-screen flex items-center justify-center bg-cover bg-center" style="background-image: url('image/background-sma.png');">
            <div class="max-w-4xl mx-auto p-8 rounded-xl">
                ...
                <h1 class="text-4xl md:text-6xl font-extrabold leading-tight mb-6 drop-shadow-md text-[#27445D] fade-in-scale delay-1">Dashboard</h1>
                <h1 class="text-4xl md:text-6xl font-extrabold leading-tight mb-6 drop-shadow-md text-[#27445D] fade-in-scale delay-2"><?php echo $nama_sekolah; ?></h1>
                <!-- Tambahkan id 'mulaiSekarangBtn' pada tombol -->
                <a href="#dashboard" id="mulaiSekarangBtn" class="inline-block bg-[#71BBB2] text-white font-bold py-3 px-8 rounded-full hover:bg-[#27445D] shadow-lg transition duration-300 bounce-in">Mulai Sekarang</a>
            </div>
        </section>

        <section id="dashboard" class="py-12 px-6 md:px-12 bg-[#27445D] rounded-xl shadow-lg mt-8 mx-4 md:mx-auto max-w-6xl relative">
            ...
            <div class="flex flex-col md:flex-row gap-4 justify-center items-center relative">
                ...
                <div class="bg-white rounded-lg shadow-md p-4 flex flex-col items-center relative">
                    <img src="image/card-sma1.png" alt="Dashboard TK A Grade" class="w-40 h-40 object-cover rounded">
                    <div class="relative mt-2">
                        <!-- Tombol ini akan membuka modal untuk TK A -->
                        <button class="bg-[#27445D] px-3 py-1 text-white rounded text-sm border border-gray-300 open-kelas-modal-btn" data-kelas="10">Pilih Kelas 10</button>
                    </div>
                </div>

                <!-- Card 2: TK B -->
                <div class="bg-white rounded-lg shadow-md p-4 flex flex-col items-center relative">
                    <img src="image/card-sma2.png" alt="Dashboard TK B Grade" class="w-40 h-40 object-cover rounded">
                    <div class="relative mt-2">
                        <!-- Tombol ini akan membuka modal untuk TK B -->
                        <button class="bg-[#27445D] px-3 py-1 text-white rounded text-sm border border-gray-300 open-kelas-modal-btn" data-kelas="11">Pilih Kelas 11</button>
                    </div>
                </div>

                <div class="bg-white rounded-lg shadow-md p-4 flex flex-col items-center relative">
                    <img src="image/card-sma3.png" alt="Dashboard TK B Grade" class="w-40 h-40 object-cover rounded">
                    <div class="relative mt-2">
                        <!-- Tombol ini akan membuka modal untuk TK B -->
                        <button class="bg-[#27445D] px-3 py-1 text-white rounded text-sm border border-gray-300 open-kelas-modal-btn" data-kelas="12">Pilih Kelas 12</button>
                    </div>
                </div>
        ...
        <div id="kelasModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden z-50">
            <div class="bg-white rounded-lg shadow-lg p-6 w-80">
                ...
                <button id="closeModal" class="mt-4 bg-[#27445D] text-white px-4 py-2 rounded hover:bg-red-600 w-full">Tutup</button>
            </div>
        </div>


        <section id="instagram" class="py-12 px-6 md:px-12 bg-white rounded-xl shadow-lg mt-8 mx-4 md:mx-auto max-w-6xl">
            <h2 class="text-3xl md:text-4xl font-bold text-center text-gray-800 mb-10 drop-shadow-lg">Postingan <span class="text-[#27445D] drop-shadow-lg">Instagram</span></h2>
        ...
        <section id="pendaftaran" class="bg-[#27445D] text-white py-16 px-6 md:px-12 text-center rounded-xl shadow-lg mx-4 md:mx-auto max-w-6xl mt-8">
            ...
            <a href="#kontak" class="inline-block bg-black text-white font-bold py-3 px-8 rounded-full shadow-lg hover:bg-[#71BBB2] transition duration-500">Hubungi Kami</a>
        </section>

        <!-- Bagian Kontak -->
        <section id="kontak" class="py-16 px-6 md:px-12 bg-white rounded-xl shadow-lg mx-4 md:mx-auto max-w-6xl mt-8 mb-8">
            <h2 class="text-3xl md:text-4xl font-bold text-center text-gray-800 mb-10">Hubungi <span class="text-[#27445D]">Kami</span></h2>
            <div class="flex flex-col md:flex-row justify-center items-start md:space-x-12">
                <div class="md:w-1/2 mb-8 md:mb-0">
                    <p class="text-gray-700 mb-4"><strong class="text-[#27445D] drop-shadow-lg">Alamat:</strong> QJQR+5PW, Kaniang Bukit Jl. Prof. Dr. Hamka, Balai Jaring, Kec. Payakumbuh Utara, Kota Payakumbuh, Sumatera Barat 26217</p>
                    <p class="text-gray-700 mb-4"><strong class="text-[#27445D] drop-shadow-lg">Telepon:</strong> (0752) 94667</p>
                    <div class="mt-6">
                ...
                <div class="md:w-1/2 w-full">
                    ...
                    <form class="space-y-4" action="submit_message.php" method="POST">
                        ...
                        <input type="hidden" name="unit_asal" value="SMA">
                        <input type="hidden" name="redirect_url" value="sma.php"> <div>
        ...
        <!-- Footer -->
        <footer class="bg-[#27445D] text-white py-8 px-6 md:px-12 text-center rounded-t-xl mt-8">
    ...
    <script>
        ...
        const kelasOptions = {
            '10': [
                { name: 'Kelas 10 E1 (TAHFIDZ)', url: '' },
                { name: 'Kelas 10 E2 (STEAM BILINGUAL)', url: '' },
                { name: 'Kelas 10 E3 (ENTREPRENEUR)', url: '' },
            ],
            '11': [
                { name: 'Kelas 10 F1 (TAHFIDZ', url: '' },
                { name: 'Kelas 10 F2 (STEAM BILINGUAL)', url: '' },
                { name: 'Kelas 10 F3 (ENTREPRENEUR)', url: '' },
            ],
            '12': [
                { name: 'Kelas 12 IPA 1 ', url: '' },
                { name: 'Kelas 12 IPA 2 ', url: '' },
                { name: 'Kelas 12 IPA 3 ', url: '' },
