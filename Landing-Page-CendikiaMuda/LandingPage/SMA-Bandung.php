...
<head>
    ...
    <link rel="icon" type="image/png" href="../icon/iconSma.png">
    <style>
         @font-face {
        ...
        .hero-background {
            background-image: url('../image/backgroundSma.png'); /* Ganti dengan jalur gambar latar belakang Anda */
...
<body class="antialiased">
    ...
    <header class="bg-white shadow-md px-6 md:px-12 sticky top-0 z-50 rounded-b-lg">
        <nav class="container mx-auto flex justify-between items-center">
            ...
            <a href="#" class="flex items-center space-x-2">
                <img src="../image/logoSma.png" alt="Logo Sekolah" class="h-20 w-30">
            </a>
    ...
    <section id="beranda" class="hero-background py-20 md:py-32 text-center mb-12 h-[500px] md:h-[630px] flex flex-col justify-center">
        <div class="hero-content text-white text-left max-w-4xl px-6">
            ...
            <p class="text-3xl md:text-6xl font-extrabold text-[#0066a0] mb-10 max-w-2xl drop-shadow-md">
                SMA ISLAM CENDEKIA MUDA
            </p>
            <a href="#kelas" class="bg-white hover:bg-[#0066a0] text-[#0066a0] hover:text-white font-bold py-3 px-8 rounded-full text-lg transition duration-900 transform hover:scale-105 shadow-lg">
                Mulai Sekarang
            </a>
        </div>
    </section>
    ...
    <section id="kelas" class="container mx-auto px-6 md:px-12 py-16 mb-12 bg-[#0066a0] rounded-lg shadow-xl text-center">
    ...
    <section id="galeri-video" class="bg-gray-50 py-16 mb-12 rounded-lg shadow-xl">
        <div class="container mx-auto px-6 md:px-12 text-center">
            <h2 class="text-3xl md:text-4xl font-bold text-[#313556] mb-10">
                Galeri <span class="text-[#0066a0]">Video Kegiatan SMA</span>
            </h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-8">
                ...
                <div class="relative w-full h-64 rounded-lg overflow-hidden shadow-md">
                    <iframe class="w-full h-full" src="https://www.youtube.com/embed/ISqLmURVaCM" 
                        title="Profil Sekolah SMA Islam Cendekia Muda Bandung" frameborder="0" 
                ...
                <!-- Video 2 -->
                <div class="relative w-full h-64 rounded-lg overflow-hidden shadow-md">
                    <iframe class="w-full h-full" src="https://www.youtube.com/embed/AdBfW3ZkQs4" 
                        title="Synergy for Energy | Expo Project SMA Islam Cendekia Muda" frameborder="0" 
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" 
                        referrerpolicy="strict-origin-when-cross-origin" allowfullscreen>
                    </iframe>
                </div>
                ...
                <!-- Video 3 -->
                <div class="relative w-full h-64 rounded-lg overflow-hidden shadow-md">
                    <iframe class="w-full h-full" src="https://www.youtube.com/embed/D04lqcVNiFA" 
                        title="Keliling Bandung Menyelesaikan Misi dengan Ongkos Terbatas, SERU!" frameborder="0" 
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" 
                        referrerpolicy="strict-origin-when-cross-origin" allowfullscreen>
                    </iframe>
                </div>
    ...
    <footer class="bg-[#313556] text-white py-8 mt-12 rounded-t-lg">
        <div class="container mx-auto px-6 md:px-12 text-center">
            <p>&copy; 2025 SMA ISLAM CENDEKIA MUDA. Hak Cipta Dilindungi.</p>
