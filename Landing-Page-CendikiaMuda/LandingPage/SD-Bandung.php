...
<body class="antialiased">
    ...
    <section id="kelas" class="container mx-auto px-6 md:px-12 py-16 mb-12 bg-[#d62037] rounded-lg shadow-xl text-center">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="bg-indigo-50 p-8 rounded-lg shadow-md hover:shadow-xl transition duration-300 transform hover:-translate-y-2 flex flex-col items-center">
                ...
                <a href="https://level1sd.cendekiamuda.sch.id/home" class="inline-block bg-[#313556] text-white font-semibold py-2 px-6 rounded-md transition duration-300">
                    Dashboard Level 1
                </a>
            </div>
            ...
            <div class="bg-indigo-50 p-8 rounded-lg shadow-md hover:shadow-xl transition duration-300 transform hover:-translate-y-2 flex flex-col items-center">
                ...
                <a href="" class="inline-block bg-[#313556] text-white font-semibold py-2 px-6 rounded-md transition duration-300">
                    Dashboard Level 2
                </a>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-8">
                ...
                <div class="relative w-full h-64 rounded-lg overflow-hidden shadow-md">
                    <iframe class="w-full h-full"
                        src="https://www.youtube.com/embed/6rMofSvFhh0?si=sHEbjK9QvEI4gBSP"
                ...
                <div class="relative w-full h-64 rounded-lg overflow-hidden shadow-md">
                    <iframe class="w-full h-full"
                        src="https://www.youtube.com/embed/X9d1ZUDxYd8?si=_-ZWRnHB63ESlzE8" 
                ...
                <div class="relative w-full h-64 rounded-lg overflow-hidden shadow-md">
                    <iframe class="w-full h-full"
                        src="https://www.youtube.com/embed/wY-RySfOnBM" 
                        title="Plants And Animals Creation - Field Trip Level 3" 
                        frameborder="0" 
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" 
                        referrerpolicy="strict-origin-when-cross-origin" allowfullscreen>
                    </iframe>
